...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "689ab55609392728f7f5629d";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  systemd.services.git-clone = {
    ...
    script = ''
      ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_689ab55609392728f7f5629d.git ~/home/admin
      chown -R ${user}:${user} ~/home/admin/polyflow_robot_689ab55609392728f7f5629d
    '';
  };
